...
class IamStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Add ECR permissions so SageMaker can pull our BioNeMo container
        ...
        self.sagemaker_execution_role.add_to_policy(ecr_policy)
        ...
        # EC2 data preparation role
        # Used by throwaway EC2 instances that download genomic data and write to FSx.
        # Needs SSM for keyless debug access, CloudWatch Logs for script output,
        # and self-terminate so instances clean themselves up when done.
        self.ec2_data_prep_role = iam.Role(
            self,
            "Ec2DataPrepRole",
            role_name="cross-az-fsx-ec2-data-prep-role",
            description="Role for throwaway EC2 instances that stage genomic data on FSx",
        ...
        self.ec2_data_prep_role.add_to_policy(
            iam.PolicyStatement(
                sid="SelfTerminate",
                effect=iam.Effect.ALLOW,
                ...
                conditions={
                    "StringEquals": {
                        "ec2:ResourceTag/Project": "cross-az-fsx-validation",
                    },
                },
            )
        )
        ...
        self.ec2_data_prep_instance_profile = iam.CfnInstanceProfile(
            self,
            "Ec2DataPrepInstanceProfile",
            instance_profile_name="cross-az-fsx-ec2-data-prep-profile",
            roles=[self.ec2_data_prep_role.role_name],
        )
        ...
        CfnOutput(
            self,
            "Ec2DataPrepInstanceProfileName",
            value=self.ec2_data_prep_instance_profile.instance_profile_name,
            description="Instance profile for EC2 data preparation instances",
            export_name="Ec2DataPrepInstanceProfileName",
        )
